...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ussd_screen', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['ussd.Screen'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('ussd', ['Screen'])

        # Adding model 'Menu'
        db.create_table('ussd_menu', (
            ('screen_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ussd.Screen'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('ussd', ['Menu'])

        # Adding model 'Question'
        db.create_table('ussd_question', (
            ('screen_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ussd.Screen'], unique=True, primary_key=True)),
            ('question_text', self.gf('django.db.models.fields.TextField')()),
            ('next', self.gf('django.db.models.fields.related.ForeignKey')(related_name='previous', null=True, to=orm['ussd.Screen'])),
        ))
        db.send_create_signal('ussd', ['Question'])

        # Adding model 'Field'
        db.create_table('ussd_field', (
            ('question_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ussd.Question'], unique=True, primary_key=True)),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms_xforms.XFormField'])),
        ))
        db.send_create_signal('ussd', ['Field'])

        # Adding model 'StubScreen'
        db.create_table('ussd_stubscreen', (
            ('screen_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ussd.Screen'], unique=True, primary_key=True)),
            ('terminal', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('text', self.gf('django.db.models.fields.TextField')(default='Your session has ended, thank you.')),
        ))
        db.send_create_signal('ussd', ['StubScreen'])

        # Adding model 'Session'
        db.create_table('ussd_session', (
        ...
        db.send_create_signal('ussd', ['Session'])

        # Adding M2M table for field submissions on 'Session'
        db.create_table('ussd_session_submissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('session', models.ForeignKey(orm['ussd.session'], null=False)),
            ('xformsubmission', models.ForeignKey(orm['rapidsms_xforms.xformsubmission'], null=False))
        ))
        db.create_unique('ussd_session_submissions', ['session_id', 'xformsubmission_id'])

        # Adding model 'Navigation'
        db.create_table('ussd_navigation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('screen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ussd.Screen'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('response', self.gf('django.db.models.fields.TextField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='navigations', to=orm['ussd.Session'])),
        ))
        db.send_create_signal('ussd', ['Navigation'])


    def backwards(self, orm):
        
        # Deleting model 'Screen'
        db.delete_table('ussd_screen')

        # Deleting model 'Menu'
        db.delete_table('ussd_menu')

        # Deleting model 'Question'
        db.delete_table('ussd_question')

        # Deleting model 'Field'
        db.delete_table('ussd_field')

        # Deleting model 'StubScreen'
        db.delete_table('ussd_stubscreen')

        # Deleting model 'Session'
        db.delete_table('ussd_session')

        # Removing M2M table for field submissions on 'Session'
        db.delete_table('ussd_session_submissions')

        # Deleting model 'Navigation'
        db.delete_table('ussd_navigation')
    ...
    models = {
        ...
        'ussd.field': {
            'Meta': {'object_name': 'Field', '_ormbases': ['ussd.Question']},
            'field': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rapidsms_xforms.XFormField']"}),
            'question_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['ussd.Question']", 'unique': 'True', 'primary_key': 'True'})
        },
        'ussd.menu': {
            'Meta': {'object_name': 'Menu', '_ormbases': ['ussd.Screen']},
            'screen_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['ussd.Screen']", 'unique': 'True', 'primary_key': 'True'})
        },
        'ussd.navigation': {
            ...
            'screen': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ussd.Screen']"}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'navigations'", 'to': "orm['ussd.Session']"}),
            'text': ('django.db.models.fields.TextField', [], {})
        },
        'ussd.question': {
            'Meta': {'object_name': 'Question', '_ormbases': ['ussd.Screen']},
            'next': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'previous'", 'null': 'True', 'to': "orm['ussd.Screen']"}),
        ...
        'ussd.screen': {
            ...
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['ussd.Screen']"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
        ...
        'ussd.stubscreen': {
            'Meta': {'object_name': 'StubScreen', '_ormbases': ['ussd.Screen']},
            'screen_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['ussd.Screen']", 'unique': 'True', 'primary_key': 'True'}),
            'terminal': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {'default': "'Your session has ended, thank you.'"})
        }
    }
