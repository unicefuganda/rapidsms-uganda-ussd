...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Screen.label'
        db.alter_column('ussd_screen', 'label', self.gf('django.db.models.fields.CharField')(max_length=160))
    def backwards(self, orm):

        # Changing field 'Screen.label'
        db.alter_column('ussd_screen', 'label', self.gf('django.db.models.fields.CharField')(max_length=150))
    models = {
        'auth.group': {
